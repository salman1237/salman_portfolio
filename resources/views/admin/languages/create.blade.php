...
<div class="px-4 sm:px-0">
    <form action="{{ route('admin.languages.store') }}" method="POST" class="space-y-6 bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
        @csrf
        ...
        <div>
            ...
            <select id="proficiency" name="proficiency" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                <option value="">Select Proficiency Level</option>
                            <option value="basic" {{ old('proficiency') == 'basic' ? 'selected' : '' }}>Basic</option>
